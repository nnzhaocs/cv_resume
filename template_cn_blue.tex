...
\cvitem{[MSST '15]}{\textbf{Nannan Zhao}, Jiguang Wan, Jun Wang, and Changsheng Xie. 
	...
	IEEE International Conference on Massive Storage Systems and Technology (MSST’15), Santa Clara, CA.}
...
\cvitem{[ATC]}{\textbf{Nannan Zhao}, Vasily Tarasov, Hadeel Albahar, Ali Anwar, Lukas Rupprecht, Dimitrios Skourtis, and Ali R. Butt. \textit{DupHunter: Flexible High-Performance Deduplication for Docker Registries}. (ATC’20).}
...
\cventry{16/08–18/12}{教学助理(TA)}{弗吉尼亚理工大学}{}{}{}                % arguments 3 to 6 are optional
\cvlistitem{课程：计算机系统}
...
\cvline{19/09-现在}{针对容器编排系统的存储优化设计}
...
\cvlistitem{提出了：利用用户访问特征来预测并提前进行容器镜像重构来降低重构带来的开销。（ATC'20 审稿中）}
